  ...
  <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 ">
    <div class="main-content tab-content">
      ...
      <div id="managementPost" class="tab-pane fade in active clearfix">
        ...
        <form class="form-group clearfix" method="post" action="tim-kiem-tin-rao-ban">
    ...
    <div class="table-responsive col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
      <table class="table table-hover">
        ...
        <tbody>
          @foreach($post as $po)
          <tr>
            <td>{{$po->title}}<br><a href="chi-tiet-bai-dang/{{$po->id}}">Xem</a> <a href="sua-tin-rao-ban/{{$po->id}}">Sửa</a> <a href="tin-ban/xoa/{{$po->id}}">Xóa</a></td>
            <td>{{$po->view}}</td>
            <td>{{$po->start_date}}</td>
