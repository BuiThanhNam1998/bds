          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
                {{$trade_category->trade_category}} : Thêm thể loại
              </header>
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="admin/loai-buon-ban/loai/them/{{$trade_category->id}}">
