          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="admin/the-loai-tin-tuc/them">
                  <input type="hidden" name="_token" value="{{csrf_token()}}" />
                    <div class="form-group ">
                      <label for="news_category" class="control-label col-lg-2">Thể loại tin tức <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="news_category" name="news_category" type="text" />
                      </div>
                    </div>
