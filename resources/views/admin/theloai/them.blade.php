          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
                {{$news_category->news_category}} : Thêm thể loại
              </header>
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="admin/the-loai-tin-tuc/the-loai/them/{{$news_category->id}}">
