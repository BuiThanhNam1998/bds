          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
                {{$news_category->news_category}} - Sửa: {{$category->category}}
              </header>
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="admin/the-loai-tin-tuc/the-loai/sua/{{$category->id}}/{{$news_category->id}}">
