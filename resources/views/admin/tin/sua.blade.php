          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body"> 
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="admin/tin/sua/{{$post->id}}">
                  <input type="hidden" name="_token" value="{{csrf_token()}}" />
                    ...
                    <div class="form-group ">
                     ...
                     <div class="form-group ">
                      <label for="price" class="control-label col-lg-2">Giá<span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="price" name="price" type="text" value="{{$post->price_id}}" />
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-2" for="inputSuccess">Số phòng ngủ<span class="required">*</span></label>
                      <div class="col-lg-10">
                        <select class="form-control m-bot15" name="bedroom_number_id">
                          @foreach($bedroom_number as $bn)
                          <option value="{{$bn->id}}"
                            @if($bn->id == $post->bedroom_number->id)
                              {{"selected"}}
                            @endif
                          >
                            {{$bn->number}}
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-2" for="inputSuccess">Hướng nhà<span class="required">*</span></label>
                      <div class="col-lg-10">
                        <select class="form-control m-bot15" name="direction_id">
                          @foreach($direction as $di)
                          <option value="{{$di->id}}"
                            @if($di->id == $post->direction->id)
                              {{"selected"}}
                            @endif
                          >
                            {{$di->direction}}
